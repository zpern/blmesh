...
{
  spdlog::info("Navigation:\n");
  spdlog::info("  left button:           rotate around the target\n");
  spdlog::info("  middle button:         zoom\n");
  spdlog::info("  left button + ctrl     quake rotate (rotate around camera position)\n");
  spdlog::info("  middle button + ctrl   walk (progress along camera's z direction)\n");
  spdlog::info("  left button:           pan (translate in the XY camera's plane)\n\n");
  spdlog::info("R : move the camera to initial position\n");
  spdlog::info("A : start/stop animation\n");
  spdlog::info("C : clear the animation\n");
  spdlog::info("G : add a key frame\n");

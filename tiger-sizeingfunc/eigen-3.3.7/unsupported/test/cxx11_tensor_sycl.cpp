...
void test_sycl_cpu(const Eigen::SyclDevice &sycl_device) {
  ...
  spdlog::info("a=1.2f Test passed\n");
  ...
  spdlog::info("a=b*1.2f Test Passed\n");
  ...
  spdlog::info("a*3.14f + b*2.7f Test Passed\n");
  ...
  spdlog::info("d= (a>0.5? b:c) Test Passed\n");

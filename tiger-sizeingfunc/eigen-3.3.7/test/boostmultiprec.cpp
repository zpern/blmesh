...
void test_boostmultiprec()
{
  ...
  spdlog::info("NumTraits<Real>::epsilon()         = " << NumTraits<Real>::epsilon());
  spdlog::info("NumTraits<Real>::dummy_precision() = " << NumTraits<Real>::dummy_precision());
  spdlog::info("NumTraits<Real>::lowest()          = " << NumTraits<Real>::lowest());
  spdlog::info("NumTraits<Real>::highest()         = " << NumTraits<Real>::highest());
  spdlog::info("NumTraits<Real>::digits10()        = " << NumTraits<Real>::digits10());

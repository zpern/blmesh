...
//     std::cerr << "filling OK\n";
    ...
    #ifdef DENSEMATRIX
    {
      spdlog::info("Eigen Dense\t" << nnzPerCol << "%\n");
...
//       spdlog::info(sm4.nonZeros() << " == " << sm1.nonZeros() );
//       exit(1);
...
//       spdlog::info("   a * b:\t" << timer.value() << endl);
    ...
    #ifndef NOGMM
    {
      spdlog::info("GMM++ sparse\t" << nnzPerCol << "%\n");

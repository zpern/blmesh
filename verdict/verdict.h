...
struct TetMetricVals
{
  ...
  //following added by XZF
  /** \sa x_tet_edge_ratio */
  VERDICT_REAL edge_ratio;
  /** \sa x_tet_minimum_dihedral */
  VERDICT_REAL minimum_dihedral;
  /** \sa x_tet_maximum_dihedral */
  VERDICT_REAL maximum_dihedral;
  /** \sa x_tet_size_change */
  VERDICT_REAL size_change;
...
#define X_TET_EDGE_RATIO             1024
#define X_TET_MINIMUM_DIHEDRAL       2048
#define X_TET_MAXIMUM_DIHEDRAL       4096
#define X_TET_SIZE_CHANGE			 8192
...
#define V_PYRAMID_ALL				 3	 /*!< \hideinitializer */
//@}
...
#define V_WEDGE_ALL					 3	 /*!< \hideinitializer */
//@}
...
#define V_TRI_EDGE_RATIO			 1024
#define X_SIZE_CHANGE				 2048
...
*/
    ...
    C_FUNC_DEF void v_prism_quality( int num_nodes, VERDICT_REAL coordinates[][3], 
        unsigned int metrics_request_flag, struct PrismMetricVals *metric_vals ); 
...
/* individual quality functions for tet elements */
	...
	// Calculate minimum dihedral and maximumu dihedral of a tet--by XZF
	...
	//! Calculates tet metric.
	/**  Maximum ratio of the cell's included angle to the angle of equilateral element.
	added by BHWang **/
...
/* individual quality functions for quad elements */
	...
	//! Calculates quad metric.
	/**  Maximum ratio of the cell's included angle to the angle of equilateral element.
		added by BHWang */
	C_FUNC_DEF VERDICT_REAL v_quad_eqangle_skew(int num_nodes, VERDICT_REAL coordinates[][3]);
...
/* individual quality functions for tri elements */
	...
	// Calculate edge ratio of a tri--by XZF

...
//=====================================================================
	...
	MVert* addVertex(const vec3d& point);
...
//=====================================================================
	...
	MVert* closestPoint(const vec3d& p);
	double closestPoint(const vec3d& p, MVert* close_v);
...
//=====================================================================
	vec3d calculatFaceCenter(MPolyFace* face);
	vec3d calculatEdgeCenter(MEdge* edge);

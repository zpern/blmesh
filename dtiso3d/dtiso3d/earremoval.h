...
public:
	...
	bool TopuAllowed(int id1, int id2);
...
private:
	...
	int nvertices = 0;
	tVertex ver_head = nullptr;
	int nears = 0;

	Tri2D *triangles = nullptr;
	int ntris = 0;

	double exp_err = 1.0e-6;
	double exp_abs = 1.0e-20;

	int g_shellNDs_ColinIdx[4][MAX_SHELL_ED];
	int g_colNDSize;
};

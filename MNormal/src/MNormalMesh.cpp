...
// �� surface id ��������Ƭ������ݣ���Ҫ�෨������ wall �棬�Լ�����ԭ״�� nonwall �档
                      ...
                      std::vector<int> *point_nonwall_to_original)
{
    ...
    while (std::getline(iss, line)) {
        ...
        // surfaceID �е������ multiply ��֧��������� nonwall ��֧��
...
// ��������� wall ���� nonwall �����ºϲ���ͬʱά���µ�ŵ�ԭʼ��š������Ĺ�ϵ��
...
{
    // ȥ�ص�ʹ�� original_id + ���꣬���ⲻͬԭʼ����غ����걻����ϲ���

...
TEST(API_Gen_Boundary_Mesh, f6_box) {
	...
	std::string filename = "f6_box/f6_box.pls";
	...
	ASSERT_EQ(CheckClosed(pnSN0, pnSEO, ppnSFFmO, ppdSNC0), 0);
	...
	DELETE_ARRAY(ppdMNC);
	DELETE_ARRAY(ppdSNC0);
	DELETE_ARRAY(ppnSFTpO);
	DELETE_ARRAY(ppnSFFmO);
}
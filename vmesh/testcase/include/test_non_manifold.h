//yhf 2021-03
#ifndef _NON_MANIFOLD_BULLET_H_
#define _NON_MANIFOLD_BULLET_H_
#include <iostream>
#include <string>
#include <fstream>
#include <algorithm>
...
TEST(API_Gen_Tetra_Mesh, Bullet003) {
	...
	int			nLN = 100;            /* 边界层层数 */
	double		dLen = 0.2;			/* 边界层第一层厚度 */
	double		dRto = 1.05;			/* 边界层厚度增长因子 */
	...
	std::string filename = "Bullet003/Bullet003.pls";
